...
public class Test01LesPlatsGarnis {
	...
	public void testViandeAuxFrites() {
		...
		assertThat(MenuController.showMenu(platGarni1)).isEqualTo(
				"- Steak de 200 g de crocodile mariné au piment africain \n"+" >Accompagnement: "+ "frites de patate douce [Prix = 14.5 euros]\n");
	...
	public void testVolailleAuxPommes2Ter() {
		...
		assertThat(MenuController.showMenu(platGarni2)).isEqualTo(
				"- Steak de 300 g de Dinde mariné à la moutarde de Dijon \n" +" >Accompagnement: "+"pomme de terre cuite au four [Prix = 15.5 euros]\n");
	...
	public void testPoissonAuxRiz() {
		...
		assertThat(MenuController.showMenu(platGarni3)).isEqualTo(
				"- Steak de 250 g de Saumon mariné à la farine de blé \n"+" >Accompagnement: "+"riz cantonais [Prix = 20.5 euros]\n");
	...
	public void testViandeAuxPates() {
		...
		assertThat(MenuController.showMenu(platGarni1)).isEqualTo(
				"- Steak de 200 g de lapin mariné au piment africain \n"+" >Accompagnement: " + "spaguetti à la Bolognaise [Prix = 14.0 euros]\n");
