...
public class Test02LesCommandes {
	...
	public static void settingTest() {
		...
		menu3 = new PommesDeTerre(menu3, "Croquettes de pommes de terre au saumon fumé", 4.5);
	...
	public void TestAddMenu() {
		...
		String str = "***********Commande de la table T01 ********************\n\n"
				...
				+ " >Accompagnement: risotto aux champignons\n" + " >Dessert: Salade de fruits tropicaux\n"
				+ "-----------------------Prix unitaire: €20.0\n"
				...
				+ " >Accompagnement: Croquettes de pommes de terre au saumon fumé\n"
