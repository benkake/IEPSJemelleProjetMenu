...
public class ViewTable extends JDialog implements PropertyChangeListener {
	...
	private void init() {
		...
		/**
		 * Ajout d'une écouteur d'événement sur l'objet tableDesCommandes
		 */
		tableDesCommandes.addMouseListener(new java.awt.event.MouseAdapter() {
			@Override
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				int row = tableDesCommandes.getSelectedRow(); // renvoie l'index de la ligne selectionnée
				Commande commandeSelected = new Commande();
				...
				contr.callViewModifFormulaire(commandeSelected);
			}
		});
	}
