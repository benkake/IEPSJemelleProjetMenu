...
public class Loader {
	...
	public void creationPlats() {
		...
		while (it1.hasNext()) {
			Element elementCategoriePlat = it1.next();
	...
	public void creationAccompagnements() {
		...
		while (it1.hasNext()) {
			Element elementCategorieAccomp = it1.next();
			...
			while (it2.hasNext()) {
				Element elementAccomp = it2.next();
	...
	public void creationDessert() {
		...
		while (it1.hasNext()) {
			Element elementCategorieDessert = it1.next();
